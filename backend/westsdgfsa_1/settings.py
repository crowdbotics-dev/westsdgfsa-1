"""
Django settings for westsdgfsa_1 project.
...
ROOT_URLCONF = 'westsdgfsa_1.urls'
...
WSGI_APPLICATION = 'westsdgfsa_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "westsdgfsa_1 API",
    "DESCRIPTION": "API documentation for westsdgfsa_1 App",
    "VERSION": "v1",
}
